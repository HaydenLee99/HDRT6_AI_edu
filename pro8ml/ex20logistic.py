# LogisticRegression - 다항 분류(softmax) - iris
import pandas as pd
import numpy as np
...
from sklearn.linear_model import LogisticRegression     # 다중 클래스를 지원하도록 일반화 됨
...
# 분류 모델 생성
model = LogisticRegression(C=1.0, solver='lbfgs',multi_class='auto', random_state=0)
